...
print("[WS] init OK")
WSCFG={MAX_REMOTES=999999,WAVE_SIZE=200,VB_CAP=20,PART_TIMEOUT=2.0,HEAD_TIMEOUT=0.8,VERIFY_TIMEOUT=1.5,BRUTE_WAIT_PARALLEL=0.22,BRUTE_WAIT_SEQUENCE=0.45,BRUTE_MODE="parallel",AUTO_EXEC=false,AUTO_RESCAN=true,RESCAN_INTERVAL=3,PERSIST=false,PERSIST_URL="https://raw.githubusercontent.com/Its-LALOL/LALOL-Hub/main/Backdoor-Scanner/script",PERSIST_URLS={"https://raw.githubusercontent.com/Its-LALOL/LALOL-Hub/main/Backdoor-Scanner/script","https://raw.githubusercontent.com/Its-LALOL/LALOL-Hub/main/main/script","https://cdn.jsdelivr.net/gh/Its-LALOL/LALOL-Hub@main/Backdoor-Scanner/script"},STATE_FILE="ws_state.json",INTEL_FILE="ws_intel.json",BLACKLIST_FILE="ws_blacklist.txt",STRICT_BACKDOOR=true,STRICT_PLAYER_FILTER=false,LOG_LIMIT=40,USE_VALUEBASE=true,USE_FOLDER_FIRST=true,USE_SINGLE_TARGET=true,AUTO_RETRY=true,RETRY_MAX=12,RESPONSE_DIFF=true,SIG_PROJECTION=true,TOKEN_REUSE=true,NESTED_ARGS=true,TIMING_FILTER=true,PAYLOAD_ENCODING=true,RANDOMIZE_SCAN=true,DERIVED_TOKENS=true,BLOCKLIST=true,TIMING_VARIANCE=true,HTTP_FALLBACK=true,CONFIDENCE_SCORE=true,SCAN_COOLDOWN=8,RF_HANG_TIMEOUT=3,HEAD_REQUIRE_CONFIRM=true,TOKEN_CRACK=true,TOKEN_MUTATE=true,ORACLE_CAP=40,SCRIPT_SCAN=true,SCRIPT_DEEP=true,SCRIPT_TOKEN_HARVEST=true,AUTO_ATTACH=true,AUTO_VERIFY_ATTACHED=true}
CFG=WSCFG
